const apiURL =
  "https://api.openweathermap.org/data/2.5/weather?lat=20.494040&lon=-86.941513&appid=fc9fe556276fc9142140291bdb778812&units=imperial";
fetch(apiURL)
...
const apiURLforecast =
  "https://api.openweathermap.org/data/2.5/forecast?lat=20.494040&lon=-86.941513&appid=fc9fe556276fc9142140291bdb778812&units=imperial";
...
fetch(apiURLforecast)
  ...
  .then((jsObject) => {
    ...
    for (var i = 0; i < jsObject.list.length; i++) {
      if (jsObject.list[i].dt_txt.substring(11) == "12:00:00") {
